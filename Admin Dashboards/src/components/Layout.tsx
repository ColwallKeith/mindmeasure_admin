...
interface LayoutProps {
  ...
  dashboardMode: 'network' | 'institutional';
  onDashboardModeChange: (mode: 'network' | 'institutional') => void;
}

export function Layout({ children, timeRange, onTimeRangeChange, dashboardMode, onDashboardModeChange }: LayoutProps) {
        ...
        <div className="flex h-16 items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <Select value={dashboardMode} onValueChange={onDashboardModeChange}>
                <SelectTrigger className="w-40">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="network">Network View</SelectItem>
                  <SelectItem value="institutional">Institutional View</SelectItem>
                </SelectContent>
              </Select>
            </div>

...
export function NetworkLayout({ children, timeRange, onTimeRangeChange }: NetworkLayoutProps) {
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Network Dashboard</p>
              </div>
            </div>
            <Separator orientation="vertical" className="h-8" />
            <div className="text-sm text-slate-600">
              <Badge variant="outline">Superuser Access</Badge>
            </div>
          </div>
